...
const load =()=>{
  ...
  const getNews = async () => {
    try {
      const response = await fetch('https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=4d69eea6e2c244fd8361e6e240d27cfc');
  ...
  return (
    <div><h1 className="heading">Sports News</h1>
