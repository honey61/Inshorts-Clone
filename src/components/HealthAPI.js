...
const load =()=>{
  setloading(loading+5);}
            async function getAPI(){
                const response = await fetch('https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=4d69eea6e2c244fd8361e6e240d27cfc');
                try{
...
useEffect(()=>{
    ...
    return(
        <div> <h1 className="heading">Health News</h1>
